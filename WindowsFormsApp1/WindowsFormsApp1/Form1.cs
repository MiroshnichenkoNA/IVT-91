...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        DataGridView dg;
        MySqlDataAdapter da;
        TextBox text1, text3, text6, text7;
        RadioButton radio1, radio2, radio3;
        RichTextBox rich1;
        CheckBox check1;
        String nazv;
        MenuItem menuItem2;
        string Connect = "Database=test;Data Source=localhost;User Id=root;Password=popkins2001; Character set=utf8";
        ...
        public Form1()
        {
            ...
            menuItem1.MenuItems.Add("Фотосъемка",
                new EventHandler(mainMenu1_Table1_Select));
            menuItem1.MenuItems.Add("Видеосъемка",
                new EventHandler(mainMenu1_Table2_Select));
            menuItem1.MenuItems.Add("Фотомонтаж",
                new EventHandler(mainMenu1_Table3_Select));
            menuItem1.MenuItems.Add("Видеомонтаж",
        ...
        private void mainMenu1_Table1_Select(object sender, System.EventArgs e)
        {
            ...
            da = new MySqlDataAdapter("Select * FROM merop where Nazvan_Merop='Фотосъемка'", Connect);
            ...
            dg.Columns[3].HeaderText = "Индивидуальные пожелания";
            dg.Columns[4].HeaderText = "Цена";
            dg.Columns[5].HeaderText = "Название Мероприятия";
            dg.Columns[6].HeaderText = "ID Менеджера";
            dg.Columns[7].HeaderText = "Согласие на встречу";
        ...
        private void mainMenu1_Table2_Select(object sender, System.EventArgs e)
        {
            ...
            dg.Location = new Point(20, 50);
            this.Controls.Add(dg);
            da = new MySqlDataAdapter("Select * FROM merop where Nazvan_Merop='Видеосъемка'", Connect);
            DataTable dt = new DataTable();
            da.Fill(dt);
            MySqlCommandBuilder cb = new MySqlCommandBuilder(da);
            dg.DataSource = dt;
        ...
        private void mainMenu1_Table3_Select(object sender, System.EventArgs e)
        {
            ...
            dg.Location = new Point(20, 50);
            this.Controls.Add(dg);
            da = new MySqlDataAdapter("Select * FROM merop where Nazvan_Merop='Фотомонтаж'", Connect);
            DataTable dt = new DataTable();
            da.Fill(dt);
            MySqlCommandBuilder cb = new MySqlCommandBuilder(da);
            dg.DataSource = dt;
        ...
        private void mainMenu1_Table4_Select(object sender, System.EventArgs e)
        {
            ...
            dg.Location = new Point(20, 50);
            this.Controls.Add(dg);
            da = new MySqlDataAdapter("Select * FROM merop where Nazvan_Merop='Видеомонтаж'", Connect);
            DataTable dt = new DataTable();
            da.Fill(dt);
            MySqlCommandBuilder cb = new MySqlCommandBuilder(da);
            dg.DataSource = dt;
        ...
        private void button1_Click(object sender, System.EventArgs e)
        {
            ...
            check1 = new CheckBox();
            check1.Text = "Обсудить с администратором лично";
            check1.Width = 250;
            check1.Location = new Point(80, 30);
            this.Controls.Add(check1);

            radio1 = new RadioButton();
            radio1.Text = "PhotoMaster";
        ...
        private void button2_Click(object sender, System.EventArgs e)
        {
            ...
            check1 = new CheckBox();
            check1.Text = "Обсудить с оператором лично";
            check1.Width = 250;
            check1.Location = new Point(80, 30);
            this.Controls.Add(check1);
            ...
            label8.Text = "Тематика(При отсутствии введите \"-\")";
            label8.Width = 320;
        ...
        private void button3_Click(object sender, System.EventArgs e)
        {
            ...
            check1 = new CheckBox();
            check1.Text = "Обсудить с монтажером лично";
            check1.Width = 250;
            check1.Location = new Point(80, 30);
            this.Controls.Add(check1);
            ...
            Label label9 = new Label();
            label9.Text = "Ваши предпочтения (При отсутствии введите \"-\")";
            label9.Width = 450;
            label9.Location = new Point(350, 10);
            this.Controls.Add(label9);
        ...
        private void button5_Click(object sender, System.EventArgs e)
        {
            ...
            if (nazv == "Фотосъемка") flag_cena = 5000;
            if (nazv == "Видеосъемка") flag_cena = 6000;
            if (nazv == "Фотомонтаж") flag_cena = 9000;
            if (nazv == "Видеомонтаж") flag_cena = 13000;
            int ID = 3;
            ...
            myConnection.Open();
            string CommandText = "INSERT INTO merop (`Company`, `FIO`,  `Tel_number`,`Individ`, `Cena`, `Nazvan_Merop`, `ID_manager`, `Vstrecha`) VALUES (@Company, @FIO,  @Tel_number, @Individ, @Cena, @Nazvan_Merop, @ID_man, @Vstrecha)";
